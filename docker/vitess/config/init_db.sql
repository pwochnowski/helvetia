...
# Pre-create keyspace databases for Helvetia
CREATE DATABASE IF NOT EXISTS vt_user_keyspace CHARACTER SET utf8mb4;
CREATE DATABASE IF NOT EXISTS vt_article_keyspace CHARACTER SET utf8mb4;
CREATE DATABASE IF NOT EXISTS vt_read_keyspace CHARACTER SET utf8mb4;
CREATE DATABASE IF NOT EXISTS vt_beread_keyspace CHARACTER SET utf8mb4;
CREATE DATABASE IF NOT EXISTS vt_popularrank_keyspace CHARACTER SET utf8mb4;
